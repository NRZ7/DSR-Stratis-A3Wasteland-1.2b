...
if (!isDedicated) then
{
	[] spawn
	{
		...
		{
			9999 cutText ["Welcome to A3Wasteland modded by 4THC, please wait for your client to initialize", "BLACK", 0.01];
...
if (hasInterface || isServer) then
{
	...
	//[] execVM "addons\Door\init.sqf";						// Doors
	[] execVM "addons\vactions\functions.sqf";				// Extra Vehicle Actions
	...
	[] execVM "addons\APOC_Airdrop_Assistance\init.sqf"; 	// APOC's Airdrop
